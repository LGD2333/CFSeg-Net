...
from CFSeg_Net.CFSeg_Net import ACC2_2
...
# Configure logger for logging information to a file
...
# Function to initialize the random seed for DataLoader workers
...
# 设置学习率
    ...
    elif model_type == 'ACC2_2':
        config_vit = config.get_CTranS_config()
        model = ACC2_2(n_channels=config.n_channels, n_classes=config.n_labels)
    ...
    # Configure optimizer based on the model type
